export const uniqArray = (array: Array<any>) => {
	return array.filter(function (item, index, self) {
		return self.indexOf(item) === index;
	});
}

export const dataMediaQueries = (array: Array<any>, dataSetValue: any) => {
	...
	if (media.length) {
		const breakpointsArray: Array<any> = [];
		media.forEach(item => {
		...
		const mdQueriesArray : Array<any> = [];
...
export const tabs = () => {
	...
	function setTitlePosition(tabsMediaArray: HTMLElement[], matchMedia: any) {
